...
cofn_train = pd.read_csv("Train_CovidFN_News.csv")
cofn_test = pd.read_csv("Test_CovidFN_News.csv")
...
get_stats(cofn_train, "co19fn_train")
get_stats(cofn_test, "co19fn_test")
