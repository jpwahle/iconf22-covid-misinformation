...
class SentencePairClassifier(nn.Module):
    ...
    def __init__(self, bert_model="bert-base-uncased", freeze_bert=False):
        ...
        # if bert_model == "distilbert-base-uncased":  # 12M parameters
        #     hidden_size = 768
        # elif bert_model == "bert-base-uncased":  # 18M parameters
        #     hidden_size = 768
        # elif bert_model == "allenai/scibert_scivocab_uncased":  # 60M parameters
        #     hidden_size = 768
    ...
    def forward(self, input_ids, attn_masks, token_type_ids):
        ...
        if self.model_name == 'roberta-base' or self.model_name == 'distilbert-base-uncased':
        	token_type_ids = None
...
def main():
	...
	path_to_model = 'models/COVID-SciBERT_lr_2e-05_val_loss_0.51809_ep_2.pt'
